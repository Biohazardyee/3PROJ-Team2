...
const AlbumDetails: React.FC = () => {
  ...
  const fetchReviews = async () => {
    try {
      ...
      const targetArtist = String(urlArtist || albumData?.artist || "")
        .toLowerCase()
        .trim();
      const targetAlbum = String(urlAlbum || albumData?.name || "")
        .toLowerCase()
        .trim();
      ...
      const filtered = allReviews.filter((rev: any) => {
        ...
        const revArtist = String(media.content?.artist || media.artist || "")
          .toLowerCase()
          .trim();
        const revAlbum = String(media.content?.name || media.name || "")
          .toLowerCase()
          .trim();
  ...
  if (loading) {
    return (
      <div className="min-h-screen bg-[#0f111a] dark:bg-slate-50 flex items-center justify-center text-white dark:text-gray-900">
      ...
      {isPlaylistModalOpen && (
        <>
          ...
          <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
            <div className="bg-[#1a1b26] dark:bg-white border border-gray-800 dark:border-gray-200 rounded-2xl p-6 w-full max-w-sm shadow-2xl">
      ...
      <main className="max-w-6xl mx-auto px-6 pt-8">
        ...
        <div className="flex flex-col md:flex-row gap-12">
          ...
          <div className="flex-1 flex flex-col gap-8">
              ...
              <div className="relative">
                ...
                {isDropdownOpen && (
                  <>
                    ...
                    ></div>
                    <div className="absolute top-full left-0 mt-2 w-full bg-[#1a1b26] dark:bg-white border border-gray-800 dark:border-gray-200 rounded-xl shadow-2xl overflow-hidden z-50">
                      {STATUT_OPTIONS.map((option) => (
                        ...
                        >
                          ...
                          <span className="text-sm font-bold text-gray-200 dark:text-gray-700 uppercase">
                            {option.label}
                          </span>
                        </button>
                      ))}
            ...
            <div className="mt-4">
              <div className="flex gap-2 mb-8 bg-[#1a1b26] dark:bg-white p-1.5 rounded-xl w-fit border border-gray-800 dark:border-gray-200 shadow-sm">
              ...
              {activeTab === "Commentaires" ? (
                <>
                  {!hasAlreadyReviewed ? (
                    <div className="mb-10 bg-[#1a1b26] dark:bg-white p-6 rounded-2xl border border-gray-800 dark:border-gray-200 shadow-sm">
                    ...
                    <div className="mb-10 bg-blue-500/10 border border-blue-500/20 p-5 rounded-2xl text-center text-sm text-blue-400 font-semibold shadow-inner">
                            ...
                            <>
                              ...
                              <div className="flex justify-between items-start mb-6">
                                <div className="flex items-center gap-4">
                                  <div
                                    onClick={() =>
                                      comment.user?.id &&
                                      navigate(`/profil/${comment.user.id}`)
                                    }
                              ...
                              <div className="flex gap-6 text-gray-500 text-sm items-center">
                                ...
                                >
                                  ...
                                  {comment.replies?.length || 0} {t("reply")}
                                </button>
                              ...
                              {expandedReplies.includes(comment.id) &&
                                comment.replies && (
                                  <div className="mt-4 pl-6 space-y-3 border-l-2 border-gray-800 dark:border-gray-200">
