  ...
  return (
    <div className="min-h-screen w-full bg-[#13131a] dark:bg-slate-50 text-white dark:text-gray-900 flex flex-col items-center justify-center p-6 font-sans transition-colors duration-300">
      ...
      <div className="mb-10 text-center">
        ...
        <h1 className="text-4xl font-bold tracking-tight mb-2 text-white dark:text-gray-900">Créer votre compte</h1>
        <p className="text-gray-400 dark:text-gray-600 text-lg">Rejoignez la communauté musicale</p>
      </div>
