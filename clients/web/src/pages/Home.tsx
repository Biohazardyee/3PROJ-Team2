    ...
    const handleSearch = async (pageNumber: number = 1) => {
        ...
        try {
            ...
            const fetchedAlbums = rawData.map((a: any) => {
                const artistName = typeof a.artist === "string" ? a.artist : a.artist?.name || t('unknown_artist');
            ...
            <div
                ...
                <div className="flex flex-col lg:flex-row gap-6 mb-4">
                    <div className="flex-1">
                        <label
                            className="block text-sm font-semibold mb-2 text-gray-300 dark:text-gray-600">{t('search_label')}</label>
                        <div
                    ...
                    <div className="w-full lg:w-1/4">
                        <label
                            className="block text-sm font-semibold mb-2 text-gray-300 dark:text-gray-600">{t('sort_label')}</label>
                ...
                <div className="flex flex-wrap gap-3">
                    ...
                    <button
                        onClick={() => setSearchMode(searchMode === "artist" ? "album" : "artist")}
                    ...
                    >
                        ...
                        {t('search_mode')}: {searchMode === "artist" ? t('mode_artist') : t('mode_album')}
                    </button>
                </div>
            </div>
