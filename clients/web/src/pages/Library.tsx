  ...
  return (
    <div className="flex flex-col gap-3 group">
      ...
      <div className="flex justify-between items-start px-1">
        <div
          className="overflow-hidden cursor-pointer flex-grow"
          onClick={() => onClick(id)}
        >
        ...
        <div className="max-w-7xl mx-auto space-y-8">
          ...
          <div className="mt-12 pt-8 border-t border-slate-800">
            ...
            {currentAlbums.length > 0 ? (
              /* ICI : Changement pour 3 colonnes de manière responsive (md:grid-cols-3) et élargissement de la box */
              <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-x-10 gap-y-12 max-w-[1050px]">
                {currentAlbums.map((item: any) => (
                  ...
                  >
                    ...
                    <div className="aspect-square bg-slate-900 rounded-2xl overflow-hidden shadow-lg relative">
                      <img
