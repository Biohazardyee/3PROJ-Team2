...
const RoomDetail: React.FC = () => {
    ...
    useEffect((): void => {
        ...
        const load = async (): Promise<void> => {
            try {
                const res: AxiosResponse = await apiClient.post(`/rooms/${id}/join`);
    ...
    useEffect((): (() => void) | void => {
        ...
        const timer = setTimeout((): void => {
            socket.emit("room_skip", {room_id: id});
        }, remaining + 500); // petite marge pour être sûr que le morceau est bien terminé

        return (): void => clearTimeout(timer);
    }, [isHost, socket, id, playback.isPlaying, playback.trackUri, playback.durationMs, playback.positionMs, playback.serverTime]);
    ...
    if (needsPassword) {
        return (
            <div className="min-h-screen bg-[#13131A] dark:bg-slate-50 text-white dark:text-gray-900 p-6 md:p-10 flex items-center justify-center transition-colors duration-300">
                <div className="max-w-sm w-full text-center bg-[#1a1d26] dark:bg-white border border-slate-800 dark:border-gray-200 rounded-2xl p-8">
                    <div className="w-14 h-14 rounded-full bg-purple-500/15 flex items-center justify-center mx-auto mb-4">
                        <Lock size={24} className="text-purple-400"/>
                    </div>
                    <h1 className="text-xl font-bold mb-2">{t("room_password_required_title", "Salon protégé")}</h1>
                    ...
                    <input
                        ...
                        autoFocus
                        className={`w-full bg-[#13131A] dark:bg-gray-50 border rounded-lg px-4 py-2.5 text-sm outline-none transition-colors mb-2 ${
                            passwordError ? "border-rose-500" : "border-slate-700 dark:border-gray-300 focus:border-purple-500"
                        }`}
                    />
                    {passwordError && (
    ...
    return (
        <div className="min-h-screen bg-[#13131A] dark:bg-slate-50 text-white dark:text-gray-900 p-6 md:p-10 transition-colors duration-300 relative">
            ...
            {!audioUnlocked && (
                <div className="fixed inset-0 z-[200] flex items-center justify-center bg-black/70 backdrop-blur-sm p-4">
                    <div className="w-full max-w-sm bg-[#1a1d26] dark:bg-white border border-slate-800 dark:border-slate-200 rounded-2xl shadow-2xl p-6 text-center">
                        <div className="w-14 h-14 rounded-full bg-purple-500/15 flex items-center justify-center mx-auto mb-4">
            ...
            <div className="max-w-5xl mx-auto space-y-6">
                <div className="flex items-center justify-between gap-4">
                    <button
                        onClick={() => navigate("/rooms")}
                        className="flex items-center gap-2 text-slate-400 hover:text-white dark:hover:text-slate-900 transition-colors"
                    >
                ...
                <div className="flex items-center justify-between flex-wrap gap-3">
                    ...
                    <button
                        ...
                        className="flex items-center gap-2 text-slate-400 dark:text-gray-500 hover:text-white dark:hover:text-gray-900 text-sm transition-colors"
                    >
                        <Users size={16}/>
                ...
                {/* Now playing */}
                <div className="bg-[#1a1d26] dark:bg-white border border-slate-800 dark:border-gray-200 rounded-2xl p-6 flex flex-col sm:flex-row gap-6 items-center">
                    <div className="w-32 h-32 rounded-xl bg-slate-900 dark:bg-gray-100 overflow-hidden flex items-center justify-center shrink-0">
                        {playback.albumArt ? (
                    ...
                    <div className="flex-1 w-full min-w-0">
                        ...
                        <p className="text-slate-400 dark:text-gray-500 truncate mb-4">{playback.artistName || "—"}</p>

                        <div className="w-full h-1.5 bg-slate-800 dark:bg-gray-200 rounded-full overflow-hidden mb-2">
                            ...
                            {isHost && (
                                <div className="flex items-center gap-3">
                                    ...
                                    <button
                                        ...
                                        className="flex items-center justify-center w-11 h-11 rounded-full bg-slate-800 dark:bg-gray-100 text-slate-200 dark:text-gray-700 hover:bg-slate-700 dark:hover:bg-gray-200 transition-colors disabled:opacity-40"
                                    >
                                        <SkipForward size={18}/>
                                    </button>
                                </div>
                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                    {/* File d'attente */}
                    <div className="bg-[#1a1d26] dark:bg-white border border-slate-800 dark:border-gray-200 rounded-2xl p-6">
                            ...
                            <div className="space-y-2 max-h-80 overflow-y-auto">
                                {queue.map((item) => (
                                    <div key={item.id} className="flex items-center gap-3 group">
                                        <div className="w-10 h-10 rounded-lg bg-slate-900 dark:bg-gray-100 overflow-hidden flex items-center justify-center shrink-0">
                                            {item.album_art_url ? (
                        ...
                        <div className="flex items-center gap-2 mt-5 pt-5 border-t border-slate-800 dark:border-gray-200">
                    ...
                    {/* Chat */}
                    <div className="bg-[#1a1d26] dark:bg-white border border-slate-800 dark:border-gray-200 rounded-2xl p-6 flex flex-col h-[420px]">
                        <div className="flex items-center justify-between mb-4">
                        ...
                        <div className="flex items-center gap-2">
                            <input
                                ...
                                className="flex-1 bg-[#13131A] dark:bg-gray-50 border border-slate-700 dark:border-gray-300 rounded-lg px-3 py-2 text-sm outline-none focus:border-purple-500 transition-colors"
                            />
                            <button
            ...
            {showParticipants && (
                ...
                >
                    <div
                        className="w-full max-w-sm bg-[#1a1d26] dark:bg-white border border-slate-800 dark:border-slate-200 rounded-2xl shadow-2xl p-6 max-h-[80vh] flex flex-col"
            ...
            {showAddTrack && (
                ...
                >
                    <div
                        className="w-full max-w-md bg-[#1a1d26] dark:bg-white border border-slate-800 dark:border-slate-200 rounded-2xl shadow-2xl p-6 max-h-[80vh] flex flex-col"
                        onClick={(e) => e.stopPropagation()}
                    >
                        <div className="flex items-center justify-between mb-4">
                        ...
                        <div className="flex items-center bg-[#13131A] dark:bg-gray-50 rounded-lg px-3 py-2.5 border border-slate-700 dark:border-gray-300 mb-4">
                            ...
                            {trackSearching ? (
                                ...
                                trackResults.map((track) => (
                                    <button
                                        ...
                                        className="w-full flex items-center gap-3 p-2 rounded-lg hover:bg-slate-800/60 dark:hover:bg-gray-100 transition-colors text-left"
                                    >
                                        <div className="w-10 h-10 rounded-lg bg-slate-900 dark:bg-gray-100 overflow-hidden flex items-center justify-center shrink-0">
                                            {track.albumArt ? (
