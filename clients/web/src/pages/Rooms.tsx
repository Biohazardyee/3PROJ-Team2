...
const RoomCard: React.FC<{ room: RoomSummary; onClick: () => void }> = ({room, onClick}) => {
    ...
    return (
        <div
            onClick={onClick}
            className="bg-[#1a1d26] dark:bg-white border border-slate-800 dark:border-gray-200 rounded-2xl p-6 cursor-pointer hover:border-slate-700 dark:hover:border-gray-300 transition-all shadow-sm"
        >
            <div className="flex items-center justify-between mb-4">
                <div className={`w-10 h-10 rounded-full flex items-center justify-center ${room.is_playing ? "bg-emerald-500/15 text-emerald-400" : "bg-slate-800 dark:bg-gray-100 text-slate-400"}`}>
                    <Music2 size={18}/>
                </div>
            ...
            <p className="text-slate-400 dark:text-gray-500 text-sm truncate mb-2">
...
const Rooms: React.FC = () => {
    ...
    if (!eligible) {
        ...
        return (
            <div className="min-h-screen bg-[#13131A] dark:bg-slate-50 text-white dark:text-gray-900 p-6 md:p-10 flex items-center justify-center transition-colors duration-300">
                <div className="max-w-md text-center bg-[#1a1d26] dark:bg-white border border-slate-800 dark:border-gray-200 rounded-2xl p-8">
                    <div className="w-16 h-16 rounded-full bg-emerald-500/10 flex items-center justify-center mx-auto mb-5">
                        <Radio size={28} className="text-emerald-500"/>
                    </div>
                    <h1 className="text-2xl font-bold mb-2">{t("rooms_title", "Salons d'écoute")}</h1>
                    <p className="text-slate-400 dark:text-gray-500 text-sm mb-6">{gateMessage}</p>
                    <button
    ...
    return (
        <div className="min-h-screen bg-[#13131A] dark:bg-slate-50 text-white dark:text-gray-900 p-6 md:p-10 transition-colors duration-300">
            <div className="max-w-6xl mx-auto">
                <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 mb-10">
                    <div>
                        <h1 className="text-4xl font-bold mb-2">{t("rooms_title", "Salons d'écoute")}</h1>
                    ...
                    <div className="flex flex-col items-end gap-2 shrink-0">
                        <button
                            ...
                            className="inline-flex items-center gap-2 bg-purple-600 hover:bg-purple-500 text-white px-5 py-3 rounded-xl text-sm font-bold transition-colors disabled:opacity-40 disabled:cursor-not-allowed"
                        >
                            <Plus size={18}/>
                ...
                {myRooms.length > 0 && (
                    <div className="mb-10">
                        <h2 className="text-lg font-bold mb-4 text-white dark:text-gray-900">
            ...
            {showCreate && (
                ...
                >
                    <div
                        className="w-full max-w-sm bg-[#1a1d26] dark:bg-white border border-slate-800 dark:border-slate-200 rounded-2xl shadow-2xl p-6"
                    ...
                    >
                        ...
                        <input
                            ...
                            maxLength={50}
                            className="w-full bg-[#13131A] dark:bg-gray-50 border border-slate-700 dark:border-gray-300 rounded-lg px-4 py-2.5 text-sm outline-none focus:border-purple-500 transition-colors mb-4"
                        />
                        ...
                        {!newRoomPublic && (
                            <div className="mb-6">
                                <div className="flex items-center bg-[#13131A] dark:bg-gray-50 border border-slate-700 dark:border-gray-300 rounded-lg px-3 py-2.5 focus-within:border-purple-500 transition-colors">
