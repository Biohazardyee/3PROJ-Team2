...
type AlbumData = {
  ...
  year: number;
  description: string;
  status: 'Ecoutés' | 'A écouter plus tard' | 'Favoris' | "Je n'aime pas"; // NOUVEAU: Permet le filtrage
}
...
const FILTERS: FilterData[] = [
  { label: 'Ecoutés', count: 4, icon: '✅' },
  { label: 'A écouter plus tard', count: 2, icon: '🎧' },
  { label: 'Favoris', count: 3, icon: '⭐' },
  { label: "Je n'aime pas", count: 1, icon: '❌' },
];

const ALBUMS: AlbumData[] = [
    // ECOUTÉS (4)
    { id: "1", title: "Deux frères", artist: "PNL", image: "https://i.scdn.co/image/ab67616d0000b2736c3966c4dd0eb2273696fe16", rating: 4.8, year: 2019, genre: "Rap", description: "L'album mythique du duo des Tarterêts.", status: 'Ecoutés' },
    { id: "2", title: "Future Nostalgia", artist: "Dua Lipa", image: "https://assets.vogue.com/photos/5e332cc5d392da0008ace994/master/w_1600%2Cc_limit/82935618_1015351858835796_6355507249911876416_n.jpg", rating: 4.5, year: 2020, genre: "Pop", description: "Un retour aux sources disco et pop des années 80.", status: 'Ecoutés' },
    { id: "3", title: "Random Access Memories", artist: "Daft Punk", image: "https://cdn-images.dzcdn.net/images/cover/311bba0fc112d15f72c8b5a65f0456c1/1900x1900-000000-80-0-0.jpg", rating: 4.9, year: 2013, genre: "Electro", description: "Le dernier chef-d'oeuvre du duo casqué.", status: 'Ecoutés' },
    { id: "4", title: "Ipséité", artist: "Damso", image: "https://cdn-images.dzcdn.net/images/cover/79ba3cd515942d1dc62f49f859a374fd/1900x1900-000000-80-0-0.jpg", rating: 4.7, year: 2017, genre: "Rap", description: "L'album de la consécration pour Damso.", status: 'Ecoutés' },
    
    // FAVORIS (3)
    { id: "5", title: "After Hours", artist: "The Weeknd", image: "https://upload.wikimedia.org/wikipedia/en/c/c1/The_Weeknd_-_After_Hours.png", rating: 4.9, year: 2020, genre: "R&B", description: "Une ère sombre et cinématographique.", status: 'Favoris' },
    { id: "6", title: "Dans la légende", artist: "PNL", image: "https://cdn-images.dzcdn.net/images/cover/3722b6f876813ecf4bdf75443bf02da1/0x1900-000000-80-0-0.jpg", rating: 5.0, year: 2016, genre: "Rap", description: "L'album de diamant en indépendant.", status: 'Favoris' },
    { id: "7", title: "Discovery", artist: "Daft Punk", image: "https://cdn-images.dzcdn.net/images/cover/5718f7c81c27e0b2417e2a4c45224f8a/0x1900-000000-80-0-0.jpg", rating: 5.0, year: 2001, genre: "Electro", description: "L'album qui a redéfini la French Touch.", status: 'Favoris' },

    // A ECOUTER PLUS TARD (2) 
    { id: "8", title: "HIT ME HARD AND SOFT", artist: "Billie Eilish", image: "https://m.media-amazon.com/images/I/71dtYuD2+-L._UF894,1000_QL80_.jpg", rating: 0, year: 2024, genre: "Pop", description: "Le dernier projet très attendu de Billie Eilish.", status: 'A écouter plus tard' },
    { id: "9", title: "Et si j'échoue ?", artist: "Bouss", image: "https://cdn-images.dzcdn.net/images/cover/d6d506590b758c871cbf1bd58b47a306/1900x1900-000000-80-0-0.jpg", rating: 0, year: 2024, genre: "Rap", description: "Le premier projet très attendu du rappeur Bouss.", status: 'A écouter plus tard' },

    // JE N'AIME PAS (1) 
    { id: "10", title: "Honestly, Nevermind", artist: "Drake", image: "https://m.media-amazon.com/images/I/916lmGL5BrL.jpg", rating: 2.5, year: 2022, genre: "Dance", description: "Un virage house inattendu qui a beaucoup divisé.", status: "Je n'aime pas" },
];

const Stats: React.FC = () => {
  // Nouvel état pour gérer l'onglet actif
  const [activeFilter, setActiveFilter] = useState<string>('Ecoutés');
  ...
  return (
    <div className="p-8 max-w-[2048px] mx-auto w-full space-y-6 min-h-screen bg-transparent dark:bg-slate-50 text-white dark:text-gray-900 transition-colors duration-300">
        ...
        {/* Header */}
      <div className="mb-8">
        <h1 className="text-4xl font-bold mb-2 text-white dark:text-gray-900">Statistiques</h1>
        <p className="text-gray-400 dark:text-gray-600 text-lg">Votre collection personnelle de musique</p>
      </div>
