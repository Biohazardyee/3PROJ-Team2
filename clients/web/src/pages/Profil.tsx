...
const Profil: React.FC = () => {
    ...
    // États du profil identiques au mobile
    ...
    const handleFileChange = (e: React.ChangeEvent<HTMLInputElement>): void => {
        ...
        reader.onloadend = () => {
            ...
            // Garde la chaine brute Base64 sans l'entête data:image/... pour matcher le backend mobile
    ...
    const handleReportUser = async (): Promise<void> => {
        try {
            // Simule ton ReportUserButton du mobile
    ...
    return (
        <div
            className="min-h-screen bg-[#0f1117] dark:bg-slate-50 text-slate-200 dark:text-gray-900 font-sans transition-colors duration-300">
            {/* Input de fichier caché pour la photo de profil */}
            <input
                type="file"
                ref={fileInputRef}
                ...
                <div className="max-w-6xl mx-auto px-6">
                    <div className="relative -mt-12 mb-6 flex flex-col md:flex-row md:items-end justify-between gap-4">
                        <div className="flex flex-col md:flex-row md:items-end gap-6">
                            {/* Avatar (Cliquable si propre profil) */}
                            <div
                            ...
                            {/* Pseudo & Identifiants dynamiques */}
                            <div className="pb-2">
                                <h1
                        ...
                        {/* Actions : Édition vs Suivi / Signalement */}
                    ...
                    <div className="max-w-2xl space-y-4">
                        ...
                        {/* Compteurs dynamiques (Followers / Following) */}
                ...
                {activeTab === "playlists" && (
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                        {playlists.map((playlist) => (
                            ...
                            >
                                <div
                                    className="w-14 h-14 bg-slate-800 dark:bg-gray-100 rounded-lg flex items-center justify-center overflow-hidden flex-shrink-0">
                                    {playlist.image_url ? (
                                        <img
                                            src={
                                                playlist.image_url.startsWith("data")
                                                    ? playlist.image_url
