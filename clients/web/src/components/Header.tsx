        ...
        if (token) {
            try {
                ...
                if (userData.profile_picture) {
                    // Gestion du format (data:image ou base64 brut)
    ...
    return (
        ...
        <header
            ...
            >
                ...
                <span
                    className="text-2xl font-black tracking-widest bg-clip-text text-transparent bg-gradient-to-r from-indigo-400 to-pink-500 hidden sm:block">
          Melodia
        </span>
            </div>
                ...
                {isLoggedIn ? (
                    <>
                        ...
                        >
                            ...
                            <span
                                className="absolute -top-1.5 -right-1.5 bg-[#FF1E56] text-white text-[10px] font-bold w-4 h-4 rounded-full flex items-center justify-center border-2 border-[#1C1C28] dark:border-white">
                2
              </span>
                        </button>
