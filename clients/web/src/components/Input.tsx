...
export const Input: React.FC<InputProps> = ({ label, type, placeholder, icon: Icon }) => (
  <div className="space-y-2">
    <label className="text-sm font-semibold ml-1 text-gray-300">{label}</label>
    <div className="relative group">
      <Icon className="absolute left-4 top-1/2 -translate-y-1/2 text-gray-500 group-focus-within:text-blue-500 transition-colors" />
      <input 
        type={type} 
