                ...
                <View style={styles.headerTextContainer}>
                    <View style={styles.headerTitle}>
                        <Icon
                            ...
                            color="#f43f5e"
                        />
                        <Text style={styles.title}>Je n'aime pas</Text>
                    </View>
                    <Text style={styles.subtitle}>Les musiques que vous n'avez pas aimées</Text>
                </View>
