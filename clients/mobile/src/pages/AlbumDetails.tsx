    ...
    const fetchReviews = async () => {
        try {
            ...
            const filtered = allReviews.filter((rev: any): boolean => {
                ...
                const revArtist: string = String(content.album?.artist || content.artist || "")
                    .toLowerCase()
                    .trim();
                const revAlbum: string = String(content.album?.name || content.name || "")
                    .toLowerCase()
                    .trim();
                                                ...
                                                <View style={styles.userInfo}>
                                                    ...
                                                    <TouchableOpacity
                                                        ...
                                                        onPress={() => {
                                                            ...
                                                            console.log("➡️ GO PROFILE:", userId);
