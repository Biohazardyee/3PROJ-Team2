...
const ProfileScreen = () => {
  ...
  const handleProfilePicturePress = async (): Promise<void> => {
    ...
    if (!result.canceled && result.assets[0].base64) {
      uploadProfilePicture(result.assets[0].base64, result.assets[0].uri);
    }
  };
        ...
        >
          <View>
            <Image
              ...
              style={styles.banner}
            />
            {/* Remplacement du View par un TouchableOpacity */}
            <TouchableOpacity
            ...
            >
              <View style={styles.profilePicInner}>
                {/* On s'assure d'abord que profile_picture est bien une string */}
