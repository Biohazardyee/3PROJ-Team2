...
class ReviewController extends Controller {
    ...
    async getAll(req: Request, res: Response, next: NextFunction): Promise<void> {
        try {
            ...
            const reviews: ReviewWithMediaDto[] = await this.service.getAll(userId);
    ...
    async getReviewsByMedia(req: Request, res: Response, next: NextFunction): Promise<void> {
        try {
            ...
            const reviews: ReviewWithMediaDto[] = await this.service.getByMediaId(mediaId, userId);

            res.status(200).json({
                message: "Reviews for this media retrieved successfully",
                reviews,
            });
        } catch (error) {
            next(error);
