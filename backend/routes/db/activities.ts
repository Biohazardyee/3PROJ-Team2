...
router.get("/feed/global", authGuard, (req, res, next: NextFunction): Promise<void> =>
    activityController.getGlobalFeed(req, res, next),
);

router.get("/feed/friends/:id", authGuard, checkAdminOrSelf, (req, res, next: NextFunction): Promise<void> =>
...
router.get(
    ...
    authGuard,
    checkAdminOrSelf,
    (req, res, next: NextFunction): Promise<void> => activityController.getDiscoveryFeed(req, res, next),
);
