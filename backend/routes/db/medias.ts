...
router.post('/status', authGuard, function (req: Request, res: Response, next: NextFunction): void {
    MediaStatusController.add(req, res, next);
});

router.get('/status', authGuard, checkAdmin, function (req: Request, res: Response, next: NextFunction): void {
    MediaStatusController.getAll(req, res, next);
})

router.get('/status/:user_id/:media_id', authGuard, function (req: Request, res: Response, next: NextFunction): void {
    MediaStatusController.getById(req, res, next);
});

router.put('/status/:user_id/:media_id', authGuard, function (req: Request, res: Response, next: NextFunction): void {
    MediaStatusController.update(req, res, next);
});

router.delete('/status/:user_id/:media_id', authGuard, function (req: Request, res: Response, next: NextFunction): void {
...
router.put('/:id', authGuard, function (req: Request, res: Response, next: NextFunction): void {
