...
router.get('/status/:user_id/:media_id', function (req, res, next: NextFunction): void {
    MediaStatusController.getStatus(req, res, next);
});

router.post('/status', function (req, res, next: NextFunction): void {
    MediaStatusController.add(req, res, next);
});

router.put('/status/:user_id/:media_id', function (req, res, next: NextFunction): void {
    MediaStatusController.update(req, res, next);
});

router.delete('/status/:user_id/:media_id', function (req, res, next: NextFunction): void {
